...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    reservations_delivered: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::reservation.reservation'
    >;
    reservations_received: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::reservation.reservation'
    >;
    ...
    failedAttempts: Attribute.Integer &
      Attribute.SetMinMax<
        {
          min: 0;
          max: 3;
...
export interface ApiLocationLocation extends Schema.CollectionType {
  ...
  attributes: {
    location_name: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    employee_delivery: Attribute.Relation<
      'api::reservation.reservation',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    employee_reception: Attribute.Relation<
      'api::reservation.reservation',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    status: Attribute.Enumeration<['Reserved', 'Loaned', 'Returned']> &
      Attribute.Required &
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    rating: Attribute.Component<'rating.rating'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::reservation.reservation',
...
export interface ApiResourceResource extends Schema.CollectionType {
  ...
  attributes: {
    ...
    is_active: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
    slug: Attribute.UID<'api::resource.resource', 'identifier'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::resource.resource',
...
export interface ApiUnitUnit extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    description: Attribute.Text;
    minimumLoanTime: Attribute.Decimal &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
